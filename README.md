...
**Visualization:**  
![Average Starting XI Age Compare](Visualizations/avg_age_starting_XI_trend_with_offseason.png)
![Average Starting XI Age Trend](Visualizations/new_coach_internal_trend.png)
...
**Visualization:**  
![Average Age by Result for All Teams](Visualizations/avg_age_by_result_all_teams_boxplot.png)
...
| `Final_Insights_and_Recommendations.md` | Final executive summary of the project's conclusions and strategic advice. |
| `Data/` | Contains the final analytical datasets. |
| `Visualizations/` | Contains the three exported PNG image files generated by the R script. |
| `Python_Scripts/` | Contains initial ETL and cleanup documentation. |
| &nbsp;&nbsp;&nbsp;&nbsp;`initial_processing.py` | Python script used for filtering, merging, and initial data extraction. |
| &nbsp;&nbsp;&nbsp;&nbsp;`Data_Cleanup_Summary.md` | Summary of manual cleanup steps and scoping decisions (e.g., ignoring venues data). |
| `SQL_Scripts/` | Contains all database-related definitions and queries. |
| &nbsp;&nbsp;&nbsp;&nbsp;`schema_setup.sql` | PostgreSQL script to define tables, Primary Keys, and Foreign Keys. |
| &nbsp;&nbsp;&nbsp;&nbsp;`cleaning_validation.sql` | SQL queries used for data quality checks, integrity validation, and documenting data limitations (e.g., sparse substitution data). |
| &nbsp;&nbsp;&nbsp;&nbsp;`final_extraction.sql` | Final analytical queries used to generate the two key CSV datasets for visualization. |
| `R_Scripts/` | Contains all statistical analysis and plotting code. |
| &nbsp;&nbsp;&nbsp;&nbsp;`visualization_script.R` | The complete R script (using tidyverse/ggplot2) to generate all final visualizations. |
